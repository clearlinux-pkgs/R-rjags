...
Version  : 4.13
Release  : 34
URL      : https://cran.r-project.org/src/contrib/rjags_4-13.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rjags_4-13.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650387243
